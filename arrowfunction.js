...
var EmployeeDetails = /** @class */ (function () {
    function EmployeeDetails(empID, emp_name) {
        var _this = this;
        this.display = function () { return console.log("Name of this: " + _this.empID + " is " + _this.emp_name); };
        this.empID = empID;
        this.emp_name = emp_name;
    }
    return EmployeeDetails;
}());
var p = new EmployeeDetails(2345, "Tom");
p.display();
var q = new EmployeeDetails(4312, "Zidaan");
q.display();
